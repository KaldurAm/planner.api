        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 155, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patronym = table.Column<string>(maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildObject", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildObject_District_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCard_BuildObject_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "BuildObject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCard_TaskStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskUserMap", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskUserMap_TaskCard_TaskId",
                        column: x => x.TaskId,
                        principalTable: "TaskCard",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskUserMap_UserInfo_UserId",
                        column: x => x.UserId,
                        principalTable: "UserInfo",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildObject_DistrictId",
                table: "BuildObject",
                column: "DistrictId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskUserMap_TaskId",
                table: "TaskUserMap",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskUserMap_UserId",
                table: "TaskUserMap",
                column: "UserId");
